...
At Caltech, I’m working with Gregg Hallinan and Sandy Weinreb on a project called the Long Wavelength Array (LWA). The LWA is a radio interferometer composed of 256 discrete dipole antennas that produces images of the radio sky every 10 seconds. This project is particularly exciting for me because I’ve always been interested in how many distinct dishes can synthesize coherent images, sometimes with resolutions that cannot be achieved with single dish telescopes.
...
[rex2]: https://www.codecogs.com/eqnedit.php?latex=\Re\{X[2]\} "\Re\{X[2]\}"
[cos4]: https://www.codecogs.com/eqnedit.php?latex=\cos(4\pi&space;n/N) "\cos(4\pi n/N)"
[xns]: https://www.codecogs.com/eqnedit.php?latex=x[1],&space;x[2],&space;\cdots&space;x[n] "x[1], x[2], \cdots x[n]"
[yns]: https://www.codecogs.com/eqnedit.php?latey=y_k[1],&space;y_k[2],&space;\cdots&space;y_k[n] "y_k[1], y_k[2], \cdots y_k[n]"
